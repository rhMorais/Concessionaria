...
namespace ConcessionariaRepositorioADO.Repos
{
    public class ExcelRepositorio
    {
        ...
        {
            FileInfo caminhoArquivo = new FileInfo(@"C:\Users\Rafael\Desktop\ExcelGerado\" + DateTime.Now.Ticks + ".xlsx");
            GerarVendas(caminhoArquivo);
            GerarCarros(caminhoArquivo);
            GerarClientes(caminhoArquivo);
        }

        private void GerarVendas(FileInfo caminhoArquivo)
        {
            ...
            using (ExcelPackage arquivoExcel = new ExcelPackage(caminhoArquivo))
            {
                ...
                foreach (Venda venda in vendas)
                {
                    ...
                    planilha.Cells[linha, coluna++].Value = Convert.ToInt64(venda.Cliente.Clicpf);
        ...
        private void GerarCarros(FileInfo caminhoArquivo)
        {
            ...
            using (ExcelPackage arquivoExcel = new ExcelPackage(caminhoArquivo))
            {
                ...
                ExcelWorksheet planilha = arquivoExcel.Workbook.Worksheets.Add("Carros");
        ...
        private void GerarClientes(FileInfo caminhoArquivo)
        {
            ...
            using (ExcelPackage arquivoExcel = new ExcelPackage(caminhoArquivo))
            {
                ...
                ExcelWorksheet planilha = arquivoExcel.Workbook.Worksheets.Add("Clientes");
