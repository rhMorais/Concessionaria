...
CREATE TABLE CARRO (
	CARPLACA VARCHAR(9) CONSTRAINT PK_CAR PRIMARY KEY,
...
CREATE TABLE CLIENTE (
	CLICPF VARCHAR(14) NOT NULL CONSTRAINT PK_CLI PRIMARY KEY,
...
CREATE TABLE VENDA(
	...
	CLICPF VARCHAR(14) NOT NULL CONSTRAINT FK_VEN1 FOREIGN KEY REFERENCES CLIENTE(CLICPF),
...
CREATE TRIGGER EXCLUI_CARRO_DA_VENDA
ON VENDA
AFTER DELETE
AS 
BEGIN	
	...
	SELECT @CARPLACA = CARPLACA FROM DELETED
